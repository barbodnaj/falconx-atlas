...
| OAUTH2_PROVIDER             | No       | Oauth2 provider `google`, `microsoft`, or `keycloak`                                                                                                                                                                                                                                                        | (empty)               |
| OAUTH2_CLIENT_ID            | No       | Oauth2 Client ID                                                                                                                                                                                                                                                                                            | (empty)               |
| OAUTH2_CLIENT_SECRET        | No       | Oauth2 client secret                                                                                                                                                                                                                                                                                        | (empty)               |
| KEYCLOAK_URL                | No       | Keycloak server URL (e.g., `http://localhost:8090`) - Required when `OAUTH2_PROVIDER=keycloak`                                                                                                                                                                                                              | (empty)               |
| KEYCLOAK_REALM              | No       | Keycloak realm name - Required when `OAUTH2_PROVIDER=keycloak`                                                                                                                                                                                                                                              | (empty)               |
| KEYCLOAK_CLIENT_ID          | No       | Keycloak client ID - Required when `OAUTH2_PROVIDER=keycloak`                                                                                                                                                                                                                                               | (empty)               |
| KEYCLOAK_CLIENT_SECRET      | No       | Keycloak client secret - Required when `OAUTH2_PROVIDER=keycloak`                                                                                                                                                                                                                                           | (empty)               |
| KEYCLOAK_REDIRECT_URI       | No       | Keycloak redirect URI (e.g., `http://localhost:3080/auth/callback`) - Required when `OAUTH2_PROVIDER=keycloak`                                                                                                                                                                                              | (empty)               |
